...
using Hello = std::array<uint8_t, 64>;
using Index = std::array<uint8_t, 4>;
using KeyPair = std::array<uint8_t, 64>;
using PublicKey = std::array<uint8_t, 32>;
using SafetyNumber = std::array<uint8_t, 64>;
using SecretKey = std::array<uint8_t, 32>;
using Signature = std::array<uint8_t, 64>;
using Size = std::array<uint8_t, 8>;
using State = std::array<uint8_t, 2048>;
